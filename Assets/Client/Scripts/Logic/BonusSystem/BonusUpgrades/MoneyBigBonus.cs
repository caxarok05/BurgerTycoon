...
{
    public class MoneyBigBonus : Bonus
    {
        private int _moneyBonus;
        private const float _moneyСoefficient = 0.3f;
        private readonly IStaticDataService _staticDataService;
        private readonly IMoneyService _moneyService;
        private readonly BonusNotification _bonusNotification;
        public MoneyBigBonus(IStaticDataService staticDataService, IMoneyService moneyService, BonusNotification bonusNotification)
        {
            _staticDataService = staticDataService;
            _moneyService = moneyService;
            _bonusNotification = bonusNotification;

            var data = staticDataService.ForBonus(BonusType.MoneyRewardBig);
